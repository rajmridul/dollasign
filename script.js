document.addEventListener('DOMContentLoaded', () => {
    ...
    const API_KEY = 'AIzaSyDU-gK1k0bYot1TgkfBmBHavZCk1kl0Fi0'; // This is a placeholder - you should use your own API key
    ...
    function updateListenerCount() {
        ...
        if (listenerCountEl) listenerCountEl.textContent = fakeListeners;
        if (socialListenerCountEl) socialListenerCountEl.textContent = fakeListeners;
    }
